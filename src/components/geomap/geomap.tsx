...
const GeoMap: FC<GeoMapProps> = ({ geoData, tripDensity, isLoading }) => {
  ...
  const highlightFeature = (
    ...
    const popupMessage = `<div style='display:flex; flex-direction:column;'><span>Location: <b>${feature.properties?.zone}</b></span><span>Trips/Hour: <b>${density?.toString()}</b></span></div>`;
